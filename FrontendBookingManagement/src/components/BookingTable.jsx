...
export default function BookingTable({ resources, loadingResources }) {
  ...
  }, [selectedResource, selectedDate, pageNumber]);
  ...
  const selectedResourceName =
   ...
   const renderStatus = (status) => {
    ...
    const isCompleted = status === 3 || status === "Completed";
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-4">
          ...
          <div className="relative w-full" ref={dropdownRef}>
            ...
            <button
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-lg p-2.5 text-sm text-slate-200 flex justify-between items-center focus:outline-none focus:border-sky-500 text-left cursor-pointer"
            >
            ...
            <tbody className="divide-y divide-slate-700">
              {loadingBookings ? (
                ...
                bookings.map((b) => {
                  ...
                  const isFutureOrPresent = startDate ? startDate >= now : false;
                  
                   const canDelete = isConfirmed && isFutureOrPresent;
